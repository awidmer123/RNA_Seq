...
WT_case_VS_DKO_case <- results(counts_dds_DESeq, contrast = c("condition", "Lung_WT_Case", "Lung_DKO_Case"))
...
#| echo: false
#| layout-ncol: 2
#| fig-cap: "Volcano plots illustrating differential gene expression in lung tissue following Toxoplasma gondii infection. Shown are (a) WT control vs case, (b) DKO control vs case, and (c) WT case vs DKO case. Each point represents one gene; the x-axis shows log₂ fold change and the y-axis shows −log₁₀ adjusted p-values (DESeq2 Wald test)."
