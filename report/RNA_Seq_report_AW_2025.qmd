...
wt_dko_con_hits <- pick_candidates(wt_dko_con_annot, "WT control vs DKO control")

combined_hits <- rbind(wt_hits, dko_hits, wt_dko_hits, wt_dko_con_hits)
